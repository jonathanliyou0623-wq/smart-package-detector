...
The current thresholds are tuned for the controlled tabletop experiment. Use **Recalibrate empty background** whenever the sensor or background moves, and keep the scene empty until calibration finishes.
